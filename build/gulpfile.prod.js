...
var modifyCssUrls = require('gulp-modify-css-urls');//用于修改CSS URL
var rev = require('gulp-rev');//给所有打包后的资源名加hash
var revCollector = require('gulp-rev-collector');//将html与css中的资源文件名替换成打包后的资源文件名
